...
contract TestMusicBox is Test {
    ...
    function testMint() public {
        ...
        assertTrue(musicBox.mint(user, notBoundTokens, SANSoulbindable.SoulboundLevel(0)));
    }
    ...
    //     assertTrue(musicBox.mint(user, isBoundTokens, SANSoulbindable.SoulboundLevel(0)));
    // }
