...
for check in results:
    if check.get("impact") in impacts and not check["elements"][0]["source_mapping"][
        "filename_relative"
    ].startswith(("test", "lib", 'script')) and check['check'] not in omit_checks:
        print(
